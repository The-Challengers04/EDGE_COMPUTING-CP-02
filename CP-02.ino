...
int ldrAlerta = 200; // Indice que define quando entra no nivel de alerta 
int ldrProblema = 300; // indice que define quando entra no nivel de problema

int tempMin = 10; // valor minimo do padrao de temperatura do sistema
int tempMax = 27;// valor maximo do padrao de temperatura do sistema

int umidadeMin = 60.0;// valor minimo do padrao de umidade do sistema
int umidadeMax = 62.0;// valor maximo do padrao de umidade do sistema
...
void loop()
{
  ...
  //Lendo Temperatura
    ...
    Serial.print(dht.readTemperature()); Serial.println(" C"); //Mostra no Monitor Serial a temperatura em ºC + unidade
